      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="group relative bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all"
            >
              {/* Quote mark */}
              <div className="text-7xl font-black text-white/10 leading-none mb-4">
                "
              </div>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-white/10">
                <div className="w-12 h-12 rounded-lg bg-white flex items-center justify-center text-black font-black text-lg">
                  {testimonial.author[0]}
                </div>
                <div>
                  <div className="font-black text-white tracking-tight">{testimonial.author}</div>
                  <div className="text-xs text-gray-400 uppercase tracking-wider font-semibold">{testimonial.role}</div>
                </div>
              </div>
        ...
        <div className="mt-20 relative">
          <div className="relative bg-white/5 border border-white/10 rounded-3xl p-12 text-center">
